...
def sine_generate(r0,r1):
    rmid = (r0 + r1) / 2
    rwid = r1 - rmid
    g = []
    for i in range(0,256):
        r = i * math.pi / 128
        v = round((math.sin(r)*rwid)+rmid)
        g.append(v)
    return g

def sine_table(name,r0,r1):
    return table_asm(name,sine_generate(r0,r1))
...
tab  = "; generated by build_data.py\n\n"
tab += sine_table("sin",-127,127) + "\n"
tab += sine_table("sinx",0,189-3) + "\n"
tab += sine_table("siny",48,174-3) + "\n"
open(tables,"wt").write(tab)
print("tables: " + tables)
